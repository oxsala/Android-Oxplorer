...
public class QuickAction extends PopupWindows implements OnDismissListener {
	...
	public void addActionItem(ActionItem action) {
		...
		// Button img = (Button) container.findViewById(R.id.iv_icon2);
		final TextView text = (TextView) container.findViewById(R.id.tv_title);
		Button i_link=(Button) container.findViewById(R.id.i_link);
		Button i_symbol=(Button) container.findViewById(R.id.i_symbol);
		Button i_edit=(Button) container.findViewById(R.id.i_edit);
		i_link.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				text.setText("i_link");
                //makeText();
			}
		});
		i_symbol.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				text.setText("i_symbol");
                //makeText();
			}
		});
		i_edit.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				text.setText("i_edit");
                //makeText();
			}
		...
		/*
		 * if (icon != null) { img.setBackgroundDrawable(icon); } else {
	...
	public void makeText(){
		Toast.makeText(this, "SYMBOL CLICKED !", Toast.LENGTH_SHORT)
		.show();
	}
}